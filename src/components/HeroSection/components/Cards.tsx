...
const StatCard = () => {
    return (
        <div className="w-full flex flex-row h-[12rem]  px-4 sm:px-6 md:flex-row gap-1 sm:gap-4 md:gap-5 mb-12 sm:mb-20 md:mb-32">
            <div className="w-full md:w-[12.44rem] h-auto md:h-[13.06rem] bg-[#F9F9F9] dark:bg-black rounded-2xl sm:rounded-3xl p-4 md:mt-48 mt-4 sm:mt-6">
            ...
            <div className="w-full md:w-[12.5rem] h-auto md:h-[18.75rem]  bg-[#DFDFFF] rounded-2xl sm:rounded-3xl dark:bg-black p-4 mt-3 sm:mt-4 md:mt-26">
            ...
            <div className="w-full md:w-[13.75rem] h-auto md:h-[23.9rem] bg-[#F9F9F9] rounded-2xl sm:rounded-3xl dark:bg-black p-4 mt-3 sm:mt-4">
                <h2 className="text-xs sm:text-sm font-bold text-black text-right dark:text-white pt-1 md:pt-3 pl-2 md:pl-4">بیش از</h2>
