  ...
  return (
    ...
    >
      <aside className="lg:flex items-center gap-4">
        <Button className="bg-light text-primary h-12 flex items-center gap-2 "
        >
        ...
        >مقالات</Button>
        <Button className="bg-light text-primary w-28"
        >درباره آلفا</Button>
        <ThemeToggle />
      </aside>
      <Image src="/AlFA.png" alt="Logo" width={78} height={78} />
      <aside className="lg:flex items-center gap-4">
        <Button className="bg-light text-primary w-max"
        >رهن و اجاره</Button>
        <Button className="bg-light text-primary w-28"
        >رزرو سریع</Button>
